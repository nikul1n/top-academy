...
from constants import PLAYER_SIZE, PLAYER_MAX_SPEED, PLAYER_MAX_RTSPD, FD_FRIC, BD_FRIC, SMALL_SAUCER_ACCURACY
...
class Bullet:
    ...
    def updateBullet(self):
        ...
        # Drawing
        pygame.draw.circle(gameDisplay, Color.white,
...
class Player:
    ...
    def updatePlayer(self):
        ...
        if self.thrust:
            ...
            if speed - BD_FRIC > 0:
                change_in_hspeed = (
                    BD_FRIC * math.cos(self.vspeed / self.hspeed))
                change_in_vspeed = (
                    BD_FRIC * math.sin(self.vspeed / self.hspeed))
                if self.hspeed != 0:
...
def gameLoop(startingState):
    ...
    while gameState != "Exit":
        ...
        while gameState == "Menu":
            ...
            drawText("ASTEROIDS", Color.white, Display.width /
                     2, Display.height / 2, 100)
            drawText("Press any key to START", Color.white,
